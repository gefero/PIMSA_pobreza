...
df_ <- df %>%
    ...
    select(iso3c,`21081`,SL.UEM.TOTL.ZS, SL.UEM.ADVN.ZS, SL.EMP.VULN.ZS,SP.POP.0014.TO, SL.TLF.PART.ZS, SL.EMP.TOTL.SP.ZS)
...
**Gráfico 3. Indicadores según grupo de países (k=4)**
...
**Gráfico 3. Indicadores según grupo de países (k=5)**
